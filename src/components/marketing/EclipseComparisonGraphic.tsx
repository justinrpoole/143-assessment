    ...
    <div className={`grid grid-cols-2 gap-6 sm:gap-10 ${className ?? ''}`} aria-hidden="true">
      ...
      <div className="flex flex-col items-center">
        ...
        <p
          ...
          style={{ color: 'var(--gold-primary)', opacity: 0.5 }}
        >
          Eclipsed Monday
        </p>
        <p
    ...
    <svg viewBox={`0 0 ${size} ${size}`} width={"100%"} style={{ maxWidth: size }}>
      <defs>
        ...
        <radialGradient id={`${uid}-corona`} cx="50%" cy="50%" r="50%">
          ...
          <stop offset="25%" stopColor="var(--gold-primary)" stopOpacity="0.2" />
        ...
        <radialGradient id={`${uid}-outer`} cx="50%" cy="50%" r="50%">
          ...
          <stop offset="40%" stopColor="var(--neon-amber)" stopOpacity="0.05" />
          <stop offset="100%" stopColor="transparent" />
        </radialGradient>
