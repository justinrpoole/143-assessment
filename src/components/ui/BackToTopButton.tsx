...
export default function BackToTopButton() {
  ...
  return (
    <button
      className="back-to-top transition-all duration-200 hover:scale-110 focus-visible:ring-2 focus-visible:ring-[color-mix(in srgb, var(--gold-primary) 70%, transparent)] focus-visible:ring-offset-2"
