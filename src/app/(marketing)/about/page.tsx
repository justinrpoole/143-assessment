...
export const metadata = {
  ...
  description: "The 20-year journey that built the 143 Leadership framework. From burnout to breakthrough — the story of how the Be The Light operating system was created.",
};
