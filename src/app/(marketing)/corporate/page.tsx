...
const USE_CASES = [
  ...
  },
  {
    ...
    description:
      "Identify high-potential leaders not by their résumé, but by their capacity range. The 143 measures 9 trainable Rays — leaders with broad range across all nine are your most adaptable.",
