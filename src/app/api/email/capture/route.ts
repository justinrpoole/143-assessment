...
function isValidEmail(email: string) {
  ...
  if (local.startsWith("+") || local.endsWith("+") || local.includes("++") || local.startsWith("-") || local.endsWith("-") || local.startsWith("_") || local.endsWith("_") || local.startsWith("'") || local.endsWith("'")) return false;
