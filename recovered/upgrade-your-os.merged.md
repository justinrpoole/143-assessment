...
const DIFFERENTIATORS = [
  {
    title: "They measure traits.",
    body:
      "Fixed categories. Same result in a crisis as on vacation. Useful for cocktail party conversation. Not for Tuesday at 3 PM.",
  },
  {
    title: "This measures state.",
    body:
      "Your results change with your load. Eclipsed today does not mean eclipsed forever. Retake in 90 days and watch the numbers move.",
  },
  {
    title: "$43 changes behavior.",
    body:
      "Free tools get saved, not used. $43 creates a threshold that makes you show up. You want a mirror. This is the one that moves with you.",
  },
];
...
export default async function UpgradeYourOsPage() {
  ...
  return (
    <main className="cosmic-page-bg">
      ...
      {/* ── ECLIPSE CONCEPT (from current production) ── */}
      <section className="mx-auto max-w-[960px] px-5 py-16 sm:px-8">
        <FadeInSection>
          <div className="text-center">
            ...
            >
              Sustained load does not destroy capacity. It eclipses it. The
              assessment measures which of your 9 leadership capacities are
              running strong and which are temporarily covered — then gives you
              the specific reps to restore access.
            </p>
          </div>
        </FadeInSection>
      ...
      {/* ── DIFFERENTIATOR (from current production) ── */}
      <section className="mx-auto max-w-[960px] px-5 pb-6 sm:px-8">
        <FadeInSection>
          <div className="text-center">
            <p
              className="text-xs font-bold uppercase tracking-widest"
            ...
            >
              ...
              <br className="hidden sm:block" /> This one shows you what is
              covered — and what to do about it.
            </h2>
          </div>
        </FadeInSection>
      ...
      {/* ── RAYS VISUAL (from current production) ── */}
      <section className="mx-auto max-w-[960px] px-5 pb-12 sm:px-8">
        <FadeInSection>
